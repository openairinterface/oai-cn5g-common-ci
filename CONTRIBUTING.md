...
1. Push your modified code to a new branch in the [GitHub repository](https://github.com/openairinterface/oai-cn5g-common-ci).
   * Please use a short and descriptive branch name.

2. Create a pull request on [GitHub](https://github.com/openairinterface/oai-cn5g-common-ci/pulls).
...
3. No CI runs on this repository's pull requests — these scripts and
   templates are consumed as a submodule by the CN5G network-function
   repositories, so they are validated through an NF's pipeline, not here.
     * Point a network-function repo's `ci-scripts/common` submodule at your
...
Please report software bugs or security issues through the [GitHub Issue Tracker](https://github.com/openairinterface/oai-cn5g-common-ci/issues).
